...
import 'package:Zibma/utils/process_indicator.dart';
  ...
  static Future<Map<String, dynamic>> getDioHttpMethod({
    ...
    if (internet) {
      ...
      try {
        ...
        // Create an Options object and set headers
        Options options = Options(
            headers: header != null ? Map<String, dynamic>.from(header) : null);
  ...
  static Future<Map<String, dynamic>> postDioHttpMethod({
    ...
    if (internet) {
      ...
      try {
        ...
        // Convert header map to Options object
        Options options = Options(
          headers: header != null ? Map<String, dynamic>.from(header) : null,
        );
